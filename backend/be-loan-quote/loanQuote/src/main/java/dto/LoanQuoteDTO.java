...
public final class LoanQuoteDTO {
    /**
     ...
     *                         overpaid or underpaid through monthly repayments
     */
    public LoanQuoteDTO(final int loanAmount, final BigDecimal rate, final BigDecimal monthlyRepayment, final BigDecimal totalRepayment) {
    ...
    public LoanQuoteDTO(int loanAmount) {
        this.loanAmount = loanAmount;
    }
